...
MeshGenPipeline::MeshGenPipeline() {
    ...
    pipeline.addDescriptors(0, 0, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1, VK_SHADER_STAGE_COMPUTE_BIT);
    pipeline.addDescriptors(0, 1, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1, VK_SHADER_STAGE_COMPUTE_BIT);
    pipeline.addDescriptors(0, 2, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1, VK_SHADER_STAGE_COMPUTE_BIT);

    pipeline.addPushConstant(0, sizeof(uint), VK_SHADER_STAGE_COMPUTE_BIT);
